...
export async function ensureSchema() {
  ...
  cached.schemaPromise = (async () => {
    ...
    await db.query(`
      ...
      ALTER TABLE categories ADD COLUMN IF NOT EXISTS customVariants jsonb DEFAULT '[]'::jsonb;
      ALTER TABLE categories ADD COLUMN IF NOT EXISTS customAddons jsonb DEFAULT '[]'::jsonb;
      ALTER TABLE categories ADD COLUMN IF NOT EXISTS customFlags jsonb DEFAULT '{}'::jsonb;
      ...
      ALTER TABLE products ADD COLUMN IF NOT EXISTS diet text;

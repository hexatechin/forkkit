import { getDb, ensureSchema } from "./mongodb";
...
export async function seedIfEmpty() {
  ...
  seeding = (async () => {
    ...
    // Idempotency guard — if seed data already present, skip
    const { rows: existing } = await db.query(
      "SELECT 1 FROM tenants WHERE slug='royalbakery' LIMIT 1",
    );
    if (existing.length) {
    ...
    const tenants = [
      {
        ...
        prepTimeMins: 60,
        socialLinks: {
          instagram: "https://instagram.com/royalbakery",
          facebook: "",
        },
        seoTitle: "Royal Bakery - Fresh cakes & pastries",
        seoDesc:
          "Order handcrafted cakes, pastries and breads online. Fast delivery.",
      },
      {
        id: cafeId,
        slug: "sunrisecafe",
    ...
    try {
      for (const tenant of tenants) {
        await db.query(
          ...
          [
            ...
            tenant.email,
            tenant.address,
            jsonValue(tenant.businessHours),
            tenant.deliveryFee,
            tenant.minOrder,
            tenant.prepTimeMins,
            jsonValue(tenant.socialLinks),
            tenant.seoTitle,
            tenant.seoDesc,
          ],
        );
      ...
      const catByName = (tid, name) =>
        cats.find((c) => c.tenantId === tid && c.name === name).id;

      const products = [
        {
          id: uuid(),
          tenantId: bakeryId,
          categoryId: catByName(bakeryId, "Cakes"),
          ...
          variants: [
            {
              ...
              options: [
                ...
                { label: "1 kg", priceDelta: 15 },
                { label: "2 kg", priceDelta: 35 },
              ],
            },
          ],
          addons: [
            { id: uuid(), name: "Candles", price: 2 },
            { id: uuid(), name: "Gift Wrap", price: 4 },
          ],
        },
        {
          id: uuid(),
        ...
        },
        {
          id: uuid(),
          tenantId: bakeryId,
          categoryId: catByName(bakeryId, "Pastries"),
        ...
        },
        {
          id: uuid(),
          tenantId: bakeryId,
          categoryId: catByName(bakeryId, "Breads"),
          name: "Sourdough Loaf",
        ...
        },
        {
          id: uuid(),
          tenantId: bakeryId,
          categoryId: catByName(bakeryId, "Cookies"),
        ...
        },
        {
          id: uuid(),
          tenantId: cafeId,
          categoryId: catByName(cafeId, "Coffee"),
          name: "Cappuccino",
          ...
          variants: [
            {
              ...
              options: [
                ...
                { label: "Regular", priceDelta: 0.75 },
                { label: "Large", priceDelta: 1.5 },
              ],
            },
          ],
          addons: [
            { id: uuid(), name: "Extra shot", price: 1 },
            { id: uuid(), name: "Oat milk", price: 0.5 },
          ],
        },
        {
          id: uuid(),
          ...
          badges: ["Cold"],
          available: true,
          addons: [{ id: uuid(), name: "Vanilla syrup", price: 0.5 }],
          variants: [],
        },
        {
          id: uuid(),
          tenantId: cafeId,
          categoryId: catByName(cafeId, "Breakfast"),
          name: "Avocado Toast",
          ...
          badges: ["Healthy"],
          available: true,
          addons: [{ id: uuid(), name: "Poached egg", price: 2 }],
          variants: [],
        },
        {
          id: uuid(),
          tenantId: cafeId,
          categoryId: catByName(cafeId, "Sandwiches"),
          name: "Grilled Chicken Panini",
          description: "Chicken, mozzarella, pesto on ciabatta.",
          images: [
        ...
        },
        {
          id: uuid(),
          tenantId: cafeId,
          categoryId: catByName(cafeId, "Drinks"),
          name: "Mango Smoothie",
    ...
    return {
      seeded: true,
      tenants: [{ slug: "royalbakery" }, { slug: "sunrisecafe" }],
    };
  })();
